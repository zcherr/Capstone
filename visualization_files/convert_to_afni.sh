# Define directories
input_dir="/mnt/c/GitHub/FPO_capstone/visualization_files/subj_data/cluster_data"  # Text file location
output_dir="/mnt/c/GitHub/FPO_capstone/visualization_files/subj_data/afni_data"   # New output location
resampled_dir="/mnt/c//GitHub/FPO_capstone/visualization_files/subj_data/resampledMasks"  # Resampled mask files location
